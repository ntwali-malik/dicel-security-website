        ...
        <div>
			...
			<div className="container-fluid page-header py-5">
				<div className="container text-center py-5">
					<h1 className="display-2 text-white mb-4 animated slideInDown">Metal Detection</h1>
				</div>
			</div>
			{/* <!-- Page Header End --> */}
				...
				<ThemeProvider theme={themes.light}>
					<PageSection style={{ 
						...
						<SectionContainer style={{
							...
							>
							<SectionHeader>
								<motion.h2 variants={itemVariants}>Advanced Metal Detection Systems</motion.h2>
								<motion.p variants={itemVariants}>High-sensitivity screening for weapons, contraband, and prohibited items.</motion.p>
							</SectionHeader>
							<FeatureGrid variants={containerVariants}>
								<FeatureCard variants={itemVariants} whileHover={{ scale: 1.02 }}>
									<div className="image-container">
										<img src="assets/img/metalDetectors/walkthroughs.png" alt="Walk-Through Detectors" loading="lazy" />
									</div>
									<h4>Walk-Through Detectors</h4>
									<p>Multi-zone archway detectors for high-traffic entrances and checkpoints.</p>
								</FeatureCard>
								<FeatureCard variants={itemVariants} whileHover={{ scale: 1.02 }}>
									<div className="image-container">
										<img src="assets/img/metalDetectors/metaldetectors.png" alt="Handheld Scanners" loading="lazy" />
									</div>
									<h4>Handheld Scanners</h4>
									<p>Portable wands for secondary screening and precise threat location.</p>
								</FeatureCard>
								<FeatureCard variants={itemVariants} whileHover={{ scale: 1.02 }}>
									<div className="image-container">
										<img src="assets/img/metalDetectors/luggageScanner.png" alt="X-Ray Baggage" loading="lazy" />
									</div>
									<h4>X-Ray Baggage</h4>
									<p>Dual-energy imaging for bags, parcels, and personal belongings.</p>
								</FeatureCard>
								<FeatureCard variants={itemVariants} whileHover={{ scale: 1.02 }}>
									<div className="image-container">
										<img src="assets/img/metalDetectors/ExplosiveDetection.jpg" alt="Explosive Detection" loading="lazy" />
									</div>
									<h4>Explosive Detection</h4>
									<p>ETD trace detection for bombs, chemicals, and hazardous materials.</p>
								</FeatureCard>
								<FeatureCard variants={itemVariants} whileHover={{ scale: 1.02 }}>
									<div className="image-container">
										<img src="assets/img/metalDetectors/VehicleScreening.jpg" alt="Vehicle Screening" loading="lazy" />
									</div>
									<h4>Vehicle Screening</h4>
									<p>Under-vehicle inspection mirrors and drive-through scanners.</p>
								</FeatureCard>
								<FeatureCard variants={itemVariants} whileHover={{ scale: 1.02 }}>
									<div className="image-container">
										<img src="assets/img/metalDetectors/OperatorTraining.jpg" alt="Operator Training" loading="lazy" />
									</div>
									<h4>Operator Training</h4>
									<p>Certified training programs and ongoing competency assessments.</p>
								</FeatureCard>
							</FeatureGrid>
							...
							<SectionHeader style={{ marginTop: '1.5rem' }}>
								...
								<motion.p variants={itemVariants}>Comprehensive threat detection for airports, government, events, and high-security facilities.</motion.p>
							</SectionHeader>
							<InfoBlock variants={containerVariants}>
								<motion.p variants={itemVariants}>
									Our metal detection solutions combine state-of-the-art technology with trained operators to identify weapons, contraband, and prohibited items. From walk-through portals to handheld wands, we provide layered security screening tailored to your threat profile and throughput requirements.
								</motion.p>
								<HighlightsGrid variants={containerVariants}>
									<HighlightCard variants={itemVariants}>
										<div className="title">High Sensitivity</div>
										<div className="desc">Multi-frequency detection with minimal false alarms.</div>
									</HighlightCard>
									<HighlightCard variants={itemVariants}>
										<div className="title">Fast Throughput</div>
										<div className="desc">Quick screening without compromising security standards.</div>
									</HighlightCard>
									<HighlightCard variants={itemVariants}>
										<div className="title">Certified Operators</div>
										<div className="desc">Trained personnel with threat recognition expertise.</div>
									</HighlightCard>
									<HighlightCard variants={itemVariants}>
										<div className="title">Compliance Ready</div>
										<div className="desc">Meets aviation, government, and industry standards.</div>
									</HighlightCard>
								</HighlightsGrid>
							</InfoBlock>
							...
							<SectionHeader style={{ marginTop: '2rem' }}>
								...
								<motion.p variants={itemVariants}>Complete metal detection solutions from assessment to operation.</motion.p>
							</SectionHeader>
							<ServicesList variants={containerVariants}>
								<ServiceItem variants={itemVariants}>
									...
									<div className="text">Threat assessment and screening requirements analysis</div>
								</ServiceItem>
								<ServiceItem variants={itemVariants}>
									<div className="badge"><i className="fas fa-check"></i></div>
									<div className="text">Equipment selection, sizing and checkpoint design</div>
								</ServiceItem>
								<ServiceItem variants={itemVariants}>
									<div className="badge"><i className="fas fa-check"></i></div>
									<div className="text">Walk-through, handheld, and X-ray system installation</div>
								</ServiceItem>
								<ServiceItem variants={itemVariants}>
									<div className="badge"><i className="fas fa-check"></i></div>
									<div className="text">Calibration, sensitivity tuning and performance testing</div>
								</ServiceItem>
								<ServiceItem variants={itemVariants}>
									<div className="badge"><i className="fas fa-check"></i></div>
									<div className="text">Operator certification, threat recognition training</div>
								</ServiceItem>
								<ServiceItem variants={itemVariants}>
									<div className="badge"><i className="fas fa-check"></i></div>
									<div className="text">Standard operating procedures and escalation protocols</div>
								</ServiceItem>
								<ServiceItem variants={itemVariants}>
									<div className="badge"><i className="fas fa-check"></i></div>
									<div className="text">Compliance documentation and audit support</div>
								</ServiceItem>
								<ServiceItem variants={itemVariants}>
									<div className="badge"><i className="fas fa-check"></i></div>
									<div className="text">Preventive maintenance and technical support</div>
								</ServiceItem>
							</ServicesList>
